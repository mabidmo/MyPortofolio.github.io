        ...
        <div class="container mx-auto">
            <div class="flex flex-wrap">
                <div class="w-full self-start px-5 mx-auto lg:pl-36 lg:pt-16">
                    ...
                    <h1 class="text-white font-bold text-2xl w-2/3 lg:text-3xl">SAMBAL IZZOKU GRESIK</h1>
                    ...
                    <img src="{{ asset('images/SambalIzzoku.png') }}" alt="img" class="w-full rounded-md my-8 lg:w-1/2">
                    <h1 class="text-white font-bold my-7 text-xl">Deskripsi</h1>
                    <p class="text-white my-2 font-normal w-1/2">Sebuuah Website yang meneyediakan berbagai macam sambal dengan harga terjangkau dan kualitas terjamin </p>
                    ...
                    <div class="text-white my-4 hover:underline font-thin hover:font-normal">
                        <a href="https://mabidmo.github.io/IzzokuSambal/">https://mabidmo.github.io/IzzokuSambal/</a>
                    </div>
                </div>
            </div>
        </div>
